...
@push('title')
    <title>Equipment Configuration</title>
@endpush
    ...
    <div class="pagetitle mb-2">
        ...
        <div class="page-nav">
            <nav class="btn-group">   
                ...
                <a href="" class="btn btn-sm btn-outline-danger active">Type</a>           
            ...
            <div class="card-body pt-4">
                <div class="row">
                    <div class="col-lg-12 mb-2">
                        <span class="fw-bold sub-heading mb-1">Type</span>
                ...
                <table id="table" class="table table-bordered" style="width: 100%;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @else
                                <td>
                                    <a class="btn btn-primary btn-sm" onclick="update_form('{{ $item->iet_id }}','{{ $item->iet_type }}','{{ $item->iet_status }}')"><i class="bi bi-pencil"></i></a>
                                    <button class="btn btn-danger btn-sm" {{ ($item->ieid_id!=null) ? 'disabled' : '' }} onclick="delete_form('{{ $item->iet_id }}','{{ $item->iet_type }}');"><i class="bi bi-eraser"></i></button>
                                </td>
                            @endif
                        </tr>
                    @endforeach
...
@push('script')
    ...
    <script>    
        ...
        function clear_form(){
            ...
            $('#place').val('');
            $('#lbl_form').html('Add');
            $('#form').attr('action', "{{ route('Admin.Equipment.Type.Insert') }}");
        }

        function update_form(item_id, item_place, item_status){
            clear_form();
            var url = "{{ route('Admin.Equipment.Type.Update', ['id'=>'%id%']) }}";
        ...
        function delete_form(id, place){
            var url = "{{ route('Admin.Equipment.Type.Delete', ['id'=>'%id%']) }}";
