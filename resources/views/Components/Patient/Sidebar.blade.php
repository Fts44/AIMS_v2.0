...
<ul class="sidebar-nav" id="sidebar-nav">
    ...
    <li class="nav-item">
        ...
        <li class="nav-item">
            <a class="nav-link {{ (str_contains(url()->current(),route('Patient.Attendance.Index'))) ? '' : 'collapsed' }}" href="{{ route('Patient.Attendance.Index') }}" id="sidebar_dashboard">
        ...
        <li class="nav-item">
            <a class="nav-link {{ (str_contains(url()->current(),'documents')) ? '' : 'collapsed' }}" href="#" id="sidebar_user_documents"  data-bs-target="#document-nav" data-bs-toggle="collapse" >
                <i class="bi bi-filetype-doc"></i>
                <span>Documents</span>
                <i class="bi bi-chevron-down ms-auto"></i>
            </a>
            <ul id="document-nav" class="nav-content collapse  {{ (str_contains(url()->current(),'documents')) ? 'show' : '' }}" data-bs-parent="#sidebar-nav">
                <li>
                    <a href="{{ route('Patient.DocumentsUploads.Index') }}" class="{{ (str_contains(url()->current(),route('Patient.DocumentsUploads.Index'))) ? 'active' : '' }}">
        ...
        <li class="nav-item">
            <a class="pe-0 nav-link {{ (str_contains(url()->current(),route('Patient.COVIDVaccinationInsurance.Index'))) ? '' : 'collapsed' }}" href="{{ route('Patient.COVIDVaccinationInsurance.Index') }}" id="sidebar_vaccination_and_insurance">
